class PostComponent {
    constructor(postRecibido, postsContainerRecibido, callback) {
        ...
        //btnNewCommentPost.onclick = this.nuevoComentario.bind(this);
    ...
    nuevoComentario(e){
        ...
        var comentario = new NewCommentComponent('callback');
        comentario.show();//Esta función es propia de newCommentComponent 
