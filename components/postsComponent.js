...
PostsComponent.prototype.showBeeDetailsPOST = function (user) {
        ...
        function processResponse(text){
            ...
            btNewPost.onclick = this.nuevoComentario.bind(this);
...
PostsComponent.prototype.cancelNewPostView = function () {
    document.getElementById('inputTxtTitle').value = '';
    document.getElementById('inputTxtBody').value = '';
...
function nuevoComentario (e) {
    ...
    this.newPostView = new NewCommentComponent('callback');
